...
class CustomIIniConfigLoadAndStoreTest {
    ...
    void testLoadFile() throws InvalidConfigFileFormatException, IOException {
        File file = new File("src/test/resources/app/ini/custom/default_config_ini.ini");
    ...
    void testStore() throws IOException {
        File actualFile = new File(
                "src/test/resources/app/ini/custom/created_config_ini.ini");
        File expectedFile = new File(
                "src/test/resources/app/ini/custom/default_config_ini.ini");
