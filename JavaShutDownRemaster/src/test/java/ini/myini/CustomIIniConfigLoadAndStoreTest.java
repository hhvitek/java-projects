...
class CustomIIniConfigLoadAndStoreTest {
    ...
    void testLoadFile_testToStringMethod()
        ...
        String filePath = "ini/myini/default_config_ini.ini";
    ...
    void testStore()
        ...
        String actualFilePath = "src/test/resources/ini/myini/created_config_ini.ini";
        String expectedFilePath = "ini/myini/default_config_ini.ini";

        ClassLoader classLoader = ClassLoader.getSystemClassLoader();
        File actualFile = new File(actualFilePath);
        File expectedFile = new File(classLoader.getResource(expectedFilePath).getFile());
